...
//var batchSize = 200
//
////Manager represetns manager that manages prepareation and verification a datastore with datasets.
...
//}
//
////RecreateDatastore clears datastore, it takes adminDatastore and targetDatastore names.
...
//}
//
//func getSQLProvider(dataset *Dataset, row *Record) dsc.DmlProvider {
...
//
//
//			inserted, updated, deleted, err = tm.prepareDatasets(datastore, &mappedDatasets.DatastoreDatasets, context, manager, connection)
//
//			if err != nil {
...
//func (tm *datasetTestManager) PrepareDatastore(datasets *DatastoreDatasets) (inserted, updated, deleted int, err error) {
...
//	}
//	inserted, updated, deleted, err = tm.prepareDatasets(datasets.Datastore, &datasets.DatastoreDatasets, context, manager, connection)
//	if err == nil {
...
//}
//
//func (tm *datasetTestManager) expandMacro(context toolbox.Context, row *Record, column string, dataset *Dataset) error {
...
//func (tm *datasetTestManager) ExpectDatasets(checkPolicy int, datasets *DatastoreDatasets) (AssertViolations, error) {
//	context := toolbox.NewContext()
//	manager := tm.managerRegistry.Get(datasets.Datastore)
...
//}
//
////NewDatasetTestManager returns a new Manager
//func NewDatasetTestManager() Manager {
