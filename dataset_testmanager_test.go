...
//
//func Init(t *testing.T) dsunit.Manager {
...
//	}
//
//	//err = datasetTestManager.RecreateDatastore(gbqDatasetId, gbqDatasetId)
//	//if err != nil {
//	//	t.Fatalf("failed to RecreateDatastore %v", err)
//	//}
//
...
//		)
//
//		inserted, updated, deleted, err := datasetTestManager.PrepareDatastore(&dsunit.DatastoreDatasets{
//			Datastore: "bar_test",
//			DatastoreDatasets: []*dsunit.Dataset{
//				dataset,
//			},
//		})
//		if err != nil {
...
//			})
//
//		_, _, _, err := datasetTestManager.PrepareDatastore(&dsunit.DatastoreDatasets{
//			Datastore: "bar_test",
//			DatastoreDatasets: []*dsunit.Dataset{
//				dataset,
//			},
...
//			})
//
//		violations, err := datasetTestManager.ExpectDatasets(dsunit.FullTableDatasetCheckPolicy, &dsunit.DatastoreDatasets{
//			Datastore: "bar_test",
//			DatastoreDatasets: []*dsunit.Dataset{
//				dataset,
//			},
...
//		)
//
//		inserted, updated, _, err := datasetTestManager.PrepareDatastore(&dsunit.DatastoreDatasets{
//			Datastore: "bar_test",
//			DatastoreDatasets: []*dsunit.Dataset{
//				initDataset,
//			},
...
//		)
//
//		violations, err := datasetTestManager.ExpectDatasets(dsunit.SnapshotDatasetCheckPolicy, &dsunit.DatastoreDatasets{
//			Datastore: "bar_test",
//			DatastoreDatasets: []*dsunit.Dataset{
//				expectedDataset,
//			},
...
//	//		DatastoreDatasets: []*dsunit.Table{
//	//			initDataset,
//	//		},
//	//	})
//	//	assert.Nil(t, err)
