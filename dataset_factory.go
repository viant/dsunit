...
//	CreateDatasets(data *DatasetResource) (*DatastoreDatasets, error)
//}
//
//
//
...
//}
//
//func (f datasetFactoryImpl) buildDatasetForRows(descriptor *dsc.TableDescriptor, rows []*Record) *Dataset {
//
...
//	var rows = make([]*Record, len(dataset))
...
//	}
//	var rows = make([]*Record, len(transfer))
...
//
////CreateDatasets crate a datasets from passed in data resources
//func (f datasetFactoryImpl) CreateDatasets(dataResource *DatasetResource) (*DatastoreDatasets, error) {
