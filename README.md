...
| RegisterFromURL(t *testing.T, URL string) bool | JSON request is fetched from URL/relative path |  [RegisterRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L46) | [RegisterResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#70)  |
...
| RecreateFromURL(t *testing.T, URL string) bool | JSON request is fetched from URL/relative path |  [RecreateRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L76) | [RecreateResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#98)  |
...
| RunSQLFromURL(t *testing.T, URL string) bool | JSON request is fetched from URL/relative path  |  [RunSQLRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L103) | [RunSQLResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#126)  |
...
| RunScriptFromURL(t *testing.T, URL string) bool | JSON request is fetched from URL/relative path |  [RunScriptRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L132) | [RunSQLResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#126)  |
...
| AddTableMappingFromURL(t *testing.T, URL string) bool |  JSON request is fetched from URL/relative path |  [MappingRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L155) | [MappingResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#217)  |
...
| InitFromURL(t *testing.T, URL string) bool |  JSON request is fetched from URL/relative path |  [InitRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L225) | [MappingResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#286)  |
...
| PrepareFromURL(t *testing.T, URL string) bool | populate databstore with provided data |  [PrepareRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L293) | [MappingResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#323)  |
...
| ExpectFromURL(t *testing.T, URL string) bool | JSON request is fetched from URL/relative path |  [ExpectRequest](https://github.com/viant/dsunit/blob/master/service_contract.go#L340) | [MappingResponse](https://github.com/viant/dsunit/blob/master/service_contract.go#380)  |
